...
id_loja = random.randint(1000,9999)
loja = marketplace(id_loja,"Casas Bahia")

#n_marketing (processos) = numero de marketplaces inicializados / ocorrencia = numero de 
def sicronizacao(n_marketplaces, ocorrencia):
